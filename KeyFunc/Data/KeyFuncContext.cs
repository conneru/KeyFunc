    ...
    public class KeyFuncContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseMySQL(
                "server=127.0.0.1;port=3306;user=root;password=bustanut;database=KeyFunc;"
            );
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>(e =>
            {
                ...
                e.HasMany(e => e.Following)
                    .WithMany(e => e.Followers)
                    .UsingEntity(e => e.ToTable("UserFollows"));
            ...
            {
                e.Property(e => e.Id).ValueGeneratedOnAdd();
                e.Property(e => e.Name).IsRequired(false);
                e.Property(e => e.Image).IsRequired(false);
                e.Property(e => e.Type).IsRequired(true);
            ...
            modelBuilder.Entity<Image>(e =>
            {
                ...
                e.Property(e => e.URL);
                e.HasMany(e => e.Tags).WithOne(e => e.Image).HasForeignKey(e=>e.ImageId).OnDelete(DeleteBehavior.Cascade);
                e.HasKey(e => e.Id);
            });
            ...
            modelBuilder.Entity<Message>(e =>
            {
                ...
                e.HasMany(e => e.UsersWhoHaveRead)
                    .WithMany(e => e.MessagesRead)
                    .UsingEntity(j => j.ToTable("ReadMessages"));
                e.HasKey(e => e.Id);
            });
        }
    }
